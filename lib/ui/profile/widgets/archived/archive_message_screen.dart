...
class ArchivedMessageScreen extends StatefulWidget {
  const ArchivedMessageScreen({Key? key}) : super(key: key);

  @override
  _ArchivedMessageScreenState createState() => _ArchivedMessageScreenState();
}

class _ArchivedMessageScreenState extends State<ArchivedMessageScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) async {
      ...
      allChatController.fetchAllChat('archive');
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // child:
                allChatController.chatList.length == 0
                    ? Container(
                        child: Column(
                          children: [
                            SizedBox(height: 80),
