class AdsViewModel {
  ...
  AdsViewModel({this.data, this.lLinks, this.mMeta});

  AdsViewModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data({this.id, this.name, this.link, this.type, this.number, this.photo});
