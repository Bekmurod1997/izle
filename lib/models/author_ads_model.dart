class AdsByAuthorModel {
  List<Data>? data;
  Links? lLinks;
  Meta? mMeta;

  AdsByAuthorModel({this.data, this.lLinks, this.mMeta});

  AdsByAuthorModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Links {
  ...
  Links({this.self, this.next, this.last});
